...
export class ProductsService {
  ...
  filterProducts(criteria: string, allProduct: Products[]): Products[] {
    ...
    switch (criteria) {
      case 'priceHtoL':
        return [...allProduct].sort((a, b) => b.price - a.price);
        break;
      case 'priceLtoH':
        return [...allProduct].sort((a, b) => a.price - b.price);
        break;
        break;
      case 'men':
        return allProduct.filter(product => product.gender === 'male');
        break;
      case 'women':
        return allProduct.filter(product => product.gender === 'female');
        break;
      case 'jeans':
        return allProduct.filter(product => product.type === 'jeans');
        break;
      case 'shirts':
        return allProduct.filter(product => product.type === 'shirt');
        break;
      case 'tshirts':
        return allProduct.filter(product => product.type === 'tshirt');
        break;
      case 'all':
        return allProduct;
        break;
      default:
        return allProduct.filter(x => x.type.toLowerCase() === criteria)
